...
class PresensiKeluarView extends GetView<PresensiController> {
  const PresensiKeluarView({Key? key}) : super(key: key);
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Section Lokasi Terkini
                      _buildSectionHeader("Lokasi Terkini", Icons.location_on),
                      const SizedBox(height: 16),

                      // Waktu Realtime dengan Indikator
                      Row(
                      ...
                      // Tombol Submit dengan Indikator Aksi
                      SizedBox(
                        width: double.infinity,
                        child: ElevatedButton(
                          onPressed: controller.submitAttendanceOut,
